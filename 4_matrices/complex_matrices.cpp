...
void test_matrix_multiplication(const int matrix_size, const int max_rand){
    ...
    result = LaGenMatComplex::zeros(matrix_size, matrix_size);
    print_matrix(result, "0");
    Blas_Mat_Mat_Trans_Mult(matrixA, matrixB, result, 1.0, 0.0);
